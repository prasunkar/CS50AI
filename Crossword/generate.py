...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        for domain in self.domains:
            for word in set(self.domains[domain]):
    ...
    def assignment_complete(self, assignment):
        ...
        """
        if not self.crossword.variables - set(assignment):
            return True
    ...
    def select_unassigned_variable(self, assignment):
        ...
        for var in self.crossword.variables - set(assignment):
            if best is None or len(self.domains[var]) < len(self.domains[best]) or len(self.crossword.neighbors(var)) > len(self.crossword.neighbors(best)):
                best = var
